-- GadgetBoss Supabase setup — paste this whole file into the Supabase SQL Editor and Run.
-- Generated from supabase/migrations/. Safe to re-run (idempotent).

-- ============================================================
-- PART 1 of 2: core schema, RLS, RPCs
-- ============================================================
